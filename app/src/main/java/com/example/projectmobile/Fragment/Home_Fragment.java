...
public class Home_Fragment extends Fragment implements SensorEventListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        placeAutocompleteUiAdapter = new PlaceAutocompleteUiAdapter(searchResultsView, placeAutocomplete, LocationEngineProvider.getBestLocationEngine(getActivity()));

        MapboxRouteLineOptions options = new MapboxRouteLineOptions.Builder(getActivity()).withRouteLineResources(new RouteLineResources.Builder().build())
                .withRouteLineBelowLayerId(LocationComponentConstants.LOCATION_INDICATOR_LAYER).build();
        routeLineView = new MapboxRouteLineView(options);
        routeLineApi = new MapboxRouteLineApi(options);

        NavigationOptions navigationOptions = new NavigationOptions.Builder(getActivity()).accessToken(getString(R.string.mapbox_access_token)).build();
                                ...
                                if (location1 != null && !location1.getId().equals(location.getId())) {
                                    if (bitmap != null && bitmap2 != null && bitmap3 != null) {
                                        ...
                                        if (selectedBitmap != null) {
                                            ...
                                            Toast.makeText(getContext(), getString(R.string.errornotfoundbitmap), Toast.LENGTH_SHORT).show();
                                        }
                                    } else {
    ...
    private void fetchRoute(Point destination) {
        ...
        locationEngine.getLastLocation(new LocationEngineCallback<LocationEngineResult>() {
            ...
            public void onSuccess(LocationEngineResult result) {
                ...
                mapboxNavigation.requestRoutes(builder.build(), new NavigationRouterCallback() {
                    ...
                    public void onFailure(@NonNull List<RouterFailure> list, @NonNull RouteOptions routeOptions) {
                        setRoute.setEnabled(true);
                        setRoute.setText(getString(R.string.SetRoute));
                        Toast.makeText(getContext(), getString(R.string.routerequestfail), Toast.LENGTH_SHORT).show();
                    }
            ...
            public void onFailure(@NonNull Exception exception) {
                Toast.makeText(getContext(), getString(R.string.locationrequestfail), Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void stopNavigation() {
        ...
        pointAnnotationManager1.deleteAll();
        setRoute.setEnabled(true);
        Toast.makeText(getContext(), getString(R.string.arrived), Toast.LENGTH_SHORT).show();
    }
    ...
    private void countPotholesOnRoute() {
        FirebaseDatabase.getInstance().getReference().child("sharedPothole").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                // Hiển thị thông báo
                Toast.makeText(getContext(), getString(R.string.numberpotholeonroute) + potholeCount, Toast.LENGTH_LONG).show();
            }
